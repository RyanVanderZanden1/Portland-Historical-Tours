        ...
        <div id="wrapper">
            ...
            <main>
                ...
                <p>Our records show you submitted the following:<br>
                  ...
                  Number of participants: <?php echo htmlspecialchars($participants, ENT_QUOTES, 'UTF-8'); ?><br>
                  Sensitivities: <?php echo htmlspecialchars($allergies, ENT_QUOTES, 'UTF-8'); ?><br>
                </p>
            </main>
